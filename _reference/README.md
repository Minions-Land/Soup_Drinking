...
> **⚠️ 版权说明**：本仓库中除 `_reference/` 文件夹外的所有文件，均来自曾短暂开源的 Claude Code 源码（[github.com/PoorOtterBob/claude-code](https://github.com/PoorOtterBob/claude-code)），版权归 Anthropic 所有，并非我们的贡献。**我们的全部贡献在 `_reference/` 文件夹中。**
